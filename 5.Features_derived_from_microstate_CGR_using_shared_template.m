...
tic;
for i = 1:100
filename='all_100RNA4447_145_4M_s30_rng';
a=readtable(strcat('.\M4_100\',filename,num2str(i),'.txt'));
b{i}=table2struct(a);
for k=1:size(b{1},1)
...
save('results_all_cgr_features','a1','a12','ao','rel_P1_mean','rel_P12_mean','rel_o_mean','rel_o_mean_control','rel_o_mean_psy','-v7.3');  